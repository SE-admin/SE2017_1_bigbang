...
public class ToDoOrdByCmp {
    String  tdSub, tdContent, tdStar, tdTime, tdCmp;

    ToDoOrdByCmp() {}
    ToDoOrdByCmp(Object data[], DefaultTableModel tableModel, ArrayList<ToDoInfo> list) {
    ...
    static class NameAscCompare implements Comparator<ToDoInfo> {
    	...
    	public int compare(ToDoInfo arg0, ToDoInfo arg1) {
    		return arg0.getTdCmp_s().compareTo(arg1.getTdCmp_s());
    	}
    }
}
