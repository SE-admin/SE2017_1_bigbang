...
public class ToDoOrdByStar {
    String  tdSub,tdStar, tdContent,  tdTime, tdCmp;

    ToDoOrdByStar() {}
    ToDoOrdByStar(Object data[], DefaultTableModel tableModel, ArrayList<ToDoInfo> list) {
    ...
    static class NameAscCompare implements Comparator<ToDoInfo> {
    	...
    	public int compare(ToDoInfo arg0, ToDoInfo arg1) {
    		return arg0.getTdStar_s() .compareTo(arg1.getTdStar_s() );
    	}
    }
}
