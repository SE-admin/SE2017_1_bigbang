...
public class ToDoOrdByTime {
    String  tdSub, tdContent, tdStar, tdTime, tdCmp;

    ToDoOrdByTime() {}
    ToDoOrdByTime(Object data[], DefaultTableModel tableModel, ArrayList<ToDoInfo> list) {
    ...
    static class NameAscCompare implements Comparator<ToDoInfo> {
    	...
    	public int compare(ToDoInfo arg0, ToDoInfo arg1) {
    		return arg0.getTdTime_s().compareTo(arg1.getTdTime_s());
    	}
    }
}
